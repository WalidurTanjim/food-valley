...
const navigation = [
    ...
    { name: 'All Foods', href: 'foods', current: false },
    { name: 'Add Food', href: 'add_foods', current: false }
]
                    ...
                    <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        ...
                        {/* Profile dropdown */}
                        {
                            user ?
                                ...
                                <button className='px-4 py-2 ms-2 rounded-md bg-gray-700 hover:bg-gray-600 text-white'>Sign In</button>
                        }
                    </div>
                </div>
            </div>
